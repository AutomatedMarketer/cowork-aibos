# Claude Cowork AI Business Operating System (AIBOS)

> *Most AI templates ship 30 skills you can't relate to. AIBOS ships 7 skills every business needs, and teaches you to build the next 30 yourself — for your business, in your voice, on your terms.*
...
AIBOS is a Claude Cowork plugin. It turns Cowork into your AI business operating system in about 90 minutes. After install, your AI teammate:
...
```
/plugin install cowork-aibos
```

That's it. AIBOS is now installed.
...
5. **Skills tour** — turn on the four built-in Cowork skills AIBOS depends on (Skill Creator, docx, pptx, canvas design), then see every AIBOS skill with a tiny demo (20 min)
...
These ship with Cowork but are OFF by default. AIBOS turns them on in Phase 5 of `/onboard`:
...
## What's NOT in AIBOS (and where to get it)

AIBOS is the foundation. It does NOT include:
...
This is an early release. Issues, suggestions, weird behavior — file at `github.com/automatedmarketer/cowork-aibos/issues` or DM `@imnunotavares`.
