---
name: audit
description: Scores the user AI business operating system on the 4 Cs (Context, Connections, Capabilities, Cadence). Returns a 0-100 score, breakdown by C, and the top 3 leverage gaps. Trigger when the user says check my system, audit my AIBOS, how am I doing, what is my score, or types /audit.
---

# Audit — Score the AIBOS
...
### Capabilities (0–25)
- Are all 7 AIBOS skills installed and functional?
