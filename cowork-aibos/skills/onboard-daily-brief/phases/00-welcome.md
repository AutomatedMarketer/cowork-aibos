...
**Mac users:**
> *"Your cowork-aibos plugin is older than v0.6.0. On Mac, the marketplace update path is unreliable (Anthropic's open bugs). Here's the working path:*
>
> *1. Download the latest `cowork-aibos.zip` from https://github.com/automatedmarketer/cowork-aibos/releases/latest*
...
**Windows users:**
> *"Your cowork-aibos plugin is older than v0.6.0. Run:*
> ```
