...
>
> **Mac:** *"Download `cowork-aibos.zip` from https://github.com/AutomatedMarketer/cowork-aibos/releases/latest, then in Claude Desktop go to Settings → Customize → Browse plugins → upload the file. Your `about-me/`, `projects/`, `outputs/`, and `_aibos/` folders all stay intact. Once updated, run `/onboard-file-organization` again."*
>
> **Windows:** *"Run `/plugin update cowork-aibos`, then run `/onboard-file-organization` again."*
