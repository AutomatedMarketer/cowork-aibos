---
name: onboard
description: Drives the 9-phase install of Cowork AI OS. Reads state.md to know where the user is, runs the current phase, updates state.md, asks if they want to continue. Resumable from any phase. Trigger when the user says start onboarding, continue onboarding, where am I in onboarding, or types /onboard.
---

# Onboard - The Cowork AI OS Install Orchestrator
...
| 7 | Skills tour | `phases/07-skills-tour.md` | Enable built-in skills, demo every Cowork AI OS skill | 15-20 min |
...
4. **Save outputs to the user workspace folder**, never to the Cowork AI OS plugin folder.
...
2. Append the final entry to `about-me/memory.md`: "Cowork AI OS install complete. Baseline 4 Cs score: X/100."
