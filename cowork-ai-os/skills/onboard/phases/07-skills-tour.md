...
**What this phase does:** First, turns on the four built-in Anthropic skills Cowork AI OS depends on (Skill Creator, docx, pptx, canvas design). Then shows the user every Cowork AI OS skill with a tiny live demo. Plants the seed for `/add-skill` as the bridge to building their own.
...
> "Phase 7 of 9: skills tour. Two parts. First, we turn on four built-in Cowork skills that Cowork AI OS needs to do its job. Then I'll show you each Cowork AI OS skill with a quick demo. About 20 minutes. Ready? Type **go**."
...
These ship with Cowork but are OFF by default. Cowork AI OS needs them ON.
...
> 
> Leave the others OFF for now (xlsx, pdf, algorithmic art, etc.). You can turn them on later if you need them — they each consume context, and Cowork AI OS doesn't need them to work.
> 
...
> "Quick verify on Skill Creator since the rest of Cowork AI OS depends on it. Type this in your current task: **'List the skills I can see right now.'** Skill Creator should appear in the list."
...
If it does appear: tell them "Good — that's the foundation. Now the Cowork AI OS tour."

---

## Step 4 — Tour each Cowork AI OS skill

Now that Cowork's built-ins are ready, walk the 7 Cowork AI OS skills.
...
> 
> Scores your Cowork AI OS on the 4 C's (Context, Connections, Capabilities, Cadence) and tells you the top 3 gaps. We'll run it for real in phase 7. Demo: I'll show you what the output looks like."
...
```markdown
# Cowork AI OS Skills Tour — completed YYYY-MM-DD
...
## Cowork AI OS skills bundled (slash + plain English aliases)
...
```
### YYYY-MM-DD — Phase 7 complete: built-ins enabled, Cowork AI OS skills toured
- **What we worked on:** Enabled Skill Creator, docx, pptx, canvas design. Demoed all 7 Cowork AI OS skills.
...
> "Phase 7 done. Cowork now has the right built-ins on, and you've seen what Cowork AI OS can do. Phase 8 sets up the two scheduled tasks — your morning brief, and your weekly tune-up. About 10 minutes. Continue?"
