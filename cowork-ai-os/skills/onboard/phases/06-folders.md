...
> - **_aibos/** — system files for the Cowork AI OS plugin itself (you don't need to touch these)
> 
...
- `_aibos/` is for Cowork AI OS plugin state only — don't touch unless I tell you to.
```
...
> "Phase 6 done. The workspace has structure now. Phase 7 is fun — I show you every Cowork AI OS skill with a tiny live demo, so you know what's available. About 15 minutes. Continue?"
