...
> "Phase 8 of 9: cadence. We're setting up two automatic routines. The first runs every morning. The second runs once a week and is the engine that keeps Cowork AI OS evolving. About 10–15 minutes. Ready? Type **go**."
...
> "When you installed Cowork AI OS, you said:
...
> "Second: the weekly tune-up. This is the engine that keeps Cowork AI OS evolving. Same flow as the morning brief.
> 
> 1. Schedule → + New task
> 2. Fill in:
>    - **Name:** Weekly tune-up
...
> "Phase 8 done. Cowork AI OS is now running on a schedule. Last phase: an integrated test that exercises everything you've built, then I generate your baseline 4 C's score. About 15 minutes. Continue?"
